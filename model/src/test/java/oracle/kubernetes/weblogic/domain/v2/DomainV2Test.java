...
public class DomainV2Test extends DomainTestBase {
  ...
  @Test
  public void whenDomainReadFromYamlWithNoSetting_defaultsToDomainHomeNotInImage()
      throws IOException {
    Domain domain = readDomain(DOMAIN_V2_SAMPLE_YAML);
  ...
  @Test
  public void whenDomainReadFromYaml_domainHomeInImageIsSet() throws IOException {
